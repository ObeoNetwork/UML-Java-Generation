 ...
 *******************************************************************************/
package org.obeonetwork.pim.uml2.gen.java.main;
...
public class Uml2java extends AbstractAcceleoGenerator {
	...
	protected AcceleoService createAcceleoService() {
		...
		if (EMFPlugin.IS_ECLIPSE_RUNNING) {
			...
			Enumeration<?> propertiesNames = additionalProperties
					.propertyNames();
			while (propertiesNames.hasMoreElements()) {
				String propertyName = (String) propertiesNames.nextElement();
				String propertyValue = additionalProperties
	...
	public void setConfigurationHolder(
			UML2JavaConfigurationHolder configurationHolder) {
		if (this.model != null) {
