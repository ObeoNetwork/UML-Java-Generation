...
public class TypePropertiesClass {
	...
	// Start of user code (user defined attributes for TypePropertiesClass)
	...
	public TypePropertiesClass() {
		// Start of user code constructor for TypePropertiesClass)
		super();
		// End of user code
	}

	// Start of user code (user defined methods for TypePropertiesClass)
